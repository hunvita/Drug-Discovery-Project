...
# Assign the fifth entry (which corresponds to the target protein, Human Acetylcholinesterase) to the selected_target variable
...
df3 = df2_nr[selection] # df3 = acetylcholinesterase_02_bioactivity_data_preprocessed
